...
var factory = function factory(Dialog, Calendar) {
  var CalendarDialog = function (_Component) {
    ...
    function CalendarDialog() {
      ...
      }, _this.actions = [{ label: 'Отмена', className: _this.props.theme.button, onClick: _this.props.onDismiss }, { label: 'ОК', className: _this.props.theme.button, name: _this.props.name, onClick: _this.handleSelect }], _temp), _possibleConstructorReturn(_this, _ret);
    }
